...
THREEx.Planets.DEFAULT_SIZE=250

// from http://planetpixelemporium.com/

THREEx.Planets.createSun	= function(){
	var geometry	= new THREE.SphereGeometry(THREEx.Planets.DEFAULT_SIZE, 32, 32)
...
THREEx.Planets.createEarthCloud	= function(){
	...
	var geometry	= new THREE.SphereGeometry(THREEx.Planets.DEFAULT_SIZE*1.02, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createSaturnRing	= function(){
	...
	var geometry	= new THREEx.Planets._RingGeometry(THREEx.Planets.DEFAULT_SIZE*1.1, 0.75, 64);
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
